...
for k in range(num_bands_to_taper):
    ...
    if Hk_mag < 1e-9:
        ...
        gains[k] = min(gk, 1.0)
# ============================================
# Manual fine-tune for fs = 192 kHz:
# Reduce summed peak near Band0 (~4 dB) by ~3 dB
# and near Band12 (~3 dB) by ~2 dB
# ============================================

gains[0]  = 0.595776  # was ≈ 0.98281  (≈ -3 dB extra cut)
gains[3]  = 0.055776  # was ≈ 0.98281  (≈ -3 dB extra cut)
gains[4]  = 0.105776  # was ≈ 0.98281  (≈ -3 dB extra cut)
gains[5]  = 0.105776  # was ≈ 0.98281  (≈ -3 dB extra cut)
gains[6]  = 0.105776  # was ≈ 0.98281  (≈ -3 dB extra cut)
gains[7]  = 0.205776  # was ≈ 0.98281  (≈ -3 dB extra cut)
gains[8]  = 0.305776  # was ≈ 0.98281  (≈ -3 dB extra cut)

gains[10]  = 0.605776  # was ≈ 0.98281  (≈ -3 dB extra cut)
#gains[12] = 0.694328  # was 1.00000    (≈ -2 dB extra cut)
gains[13] = 0.794328  
